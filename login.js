...
render(){
  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <TextInput underlineColorAndroid="transparent"  placeholder='User Name' placeholderTextColor='rgba(255,255,255,0.7)' style={styles.input}
      ...
      <TouchableOpacity style={styles.b1}>
        <Text style={styles.bText} onPress={()=>navigation.navigate("adm")} >Login</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.b1} onPress={()=>navigation.navigate("reg")}>
