  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row', marginLeft:30, marginBottom:50}} >
       ...
       <TextInput underlineColorAndroid="transparent"  placeholder='Write the reason in short if you want leave.' placeholderTextColor='rgba(255,255,255,0.7)' style={styles.input}
            onChangeText={(userName) => this.setState({userName:userName})}/>
       
        <TouchableOpacity style={styles.b1}>
            <Text style={styles.bText}>Submit Request</Text>
        </TouchableOpacity>
    
      <TouchableOpacity style={styles.b1} onPress={()=>navigation.navigate("find")}>
