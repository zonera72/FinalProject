  ...
  return(
    ...
    <View style={styles.container}>
        ...
        <View style={{flexDirection:'row'}}>
            <TextInput underlineColorAndroid="transparent"  placeholder='Search User' placeholderTextColor='rgba(255,255,255,0.7)' style={styles.input}
            onChangeText={(userName) => this.setState({userName:userName})}/>

            <TouchableOpacity style={styles.b2}>
                <Text style={styles.bText}>Search</Text>
            </TouchableOpacity>
        </View>
