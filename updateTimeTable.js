...
render(){
  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <TextInput underlineColorAndroid="transparent" placeholder='Class Name or Leave Empty(if No Class)' placeholderTextColor='rgba(255,255,255,0.7)' style={styles.input}
        onChangeText={(password) =>this.setState({ password:password})}/>

      <TouchableOpacity style={styles.b1}>
        <Text style={styles.bText}>Update Class</Text>
      </TouchableOpacity>
